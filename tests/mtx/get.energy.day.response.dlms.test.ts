import {GetEnergyDayResponse} from '../../src/mtx/commands/uplink/index.js';
...
describe('GetEnergyDayResponse dlms tests', () => runCommandDlmsTest(GetEnergyDayResponse, examples));
