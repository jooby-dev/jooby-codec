...
/**
 * correction more than once per period (`opParams.timeCorrectPeriod`) is forbidden
 */
export const TIME_CORRECTION_FAILURE = 0x99;

/**
 * correction interval (`opParams.deltaCorMin`) exceeded
 */
export const INVALID_CORRECTION_INTERVAL = 0x9a;

/**
 * time correction with crossing the boundary of the current half-hour is prohibited
 * in case `opParams.timeCorrectPassHalfhour` is false
 */
