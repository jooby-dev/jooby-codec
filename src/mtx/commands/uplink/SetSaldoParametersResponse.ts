...
/**
 * Uplink command to set device current saldo parameters.
 *
 * The corresponding downlink command: `SetSaldoParameters`.
 *
 * @example create command instance from command body hex dump
 * ```js
 * import SetSaldoParametersResponse from 'jooby-codec/mtx/commands/uplink/SetSaldoParametersResponse.js';
 *
 * const command = SetSaldoParametersResponse.fromBytes();
 *
