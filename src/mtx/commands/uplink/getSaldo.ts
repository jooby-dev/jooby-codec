 ...
 * ```js
 * import * as getSaldo from 'jooby-codec/mtx/commands/uplink/getSaldo.js';
 *
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx/commands/GetSaldo.md#response)
 */
