 ...
 * ```js
 * import * as getMagneticFieldThreshold from 'jooby-codec/mtx/commands/uplink/getMagneticFieldThreshold.js';
 *
 * // simple response
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx/commands/GetMagneticFieldThreshold.md#response)
 */
