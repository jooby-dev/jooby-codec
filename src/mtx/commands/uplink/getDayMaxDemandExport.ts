/**
 * Uplink command to get the maximum `P-` power for the day.
 *
 ...
 * ```js
 * import * as getDayMaxDemandExport from 'jooby-codec/mtx/commands/uplink/getDayMaxDemandExport.js';
 *
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx/commands/uplink/GetDayMaxDemandExport.md#response)
 */
