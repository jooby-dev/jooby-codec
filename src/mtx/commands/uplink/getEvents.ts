 ...
 * ```js
 * import * as getEvents from 'jooby-codec/mtx/commands/uplink/getEvents.js';
 *
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx/commands/uplink/GetEvents.md#response)
 */
