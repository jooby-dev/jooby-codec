...
export interface IEnergies {
     ...
     *
     * Since version `302.19.XXX` (`XXX` - decimal number) for `G` meters, the accumulated and displayed energies are `R+` instead of `A+R+`, `A-R+`.
     */
 ...
 * | `19`  | get `30`-minute load profile `R+` phase `A` (since version `302.17.009`) |
 * | `20`  | get `30`-minute load profile `R+` phase `B` (since version `302.17.009`) |
 * | `21`  | get `30`-minute load profile `R+` phase `C` (since version `302.17.009`) |
 * | `22`  | get `30`-minute load profile `R-` phase `A` (since version `302.17.009`) |
 * | `23`  | get `30`-minute load profile `R-` phase `B` (since version `302.17.009`) |
 * | `24`  | get `30`-minute load profile `R-` phase `C` (since version `302.17.009`) |
 * | `25`  | get `30`-minute voltage profile phase `A`                                |
 * | `26`  | get `30`-minute voltage profile phase `B`                                |
 * | `27`  | get `30`-minute voltage profile phase `C`                                |
 * | `31`  | get `30`-minute current profile phase `A`                                |
 * | `32`  | get `30`-minute current profile phase `B`                                |
 * | `33`  | get `30`-minute current profile phase `C`                                |
 */
 ...
 * | `19`  | Get `1/3/5/10/15/30/60`-minute load profile `R+` phase `A` (since version `302.17.009`) |
 * | `20`  | Get `1/3/5/10/15/30/60`-minute load profile `R+` phase `B` (since version `302.17.009`) |
 * | `21`  | Get `1/3/5/10/15/30/60`-minute load profile `R+` phase `C` (since version `302.17.009`) |
 * | `22`  | Get `1/3/5/10/15/30/60`-minute load profile `R-` phase `A` (since version `302.17.009`) |
 * | `23`  | Get `1/3/5/10/15/30/60`-minute load profile `R-` phase `B` (since version `302.17.009`) |
 * | `24`  | Get `1/3/5/10/15/30/60`-minute load profile `R-` phase `C` (since version `302.17.009`) |
