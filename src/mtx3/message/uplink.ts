...
toBytesMap[commands.getDemandCumulative.id] = commands.getDemandCumulative.toBytes;
...
fromBytesMap[commands.getDemandCumulative.id] = commands.getDemandCumulative.fromBytes;
