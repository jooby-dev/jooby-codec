...
toBytesMap[mtx1Commands.getDemandCumulative.id] = mtx1Commands.getDemandCumulative.toBytes;
...
toBytesMap[mtx1Commands.getQuality.id] = mtx1Commands.getQuality.toBytes;
...
fromBytesMap[mtx1Commands.getDemandCumulative.id] = mtx1Commands.getDemandCumulative.fromBytes;
...
fromBytesMap[mtx1Commands.getGsmParameters.id] = mtx1Commands.getGsmParameters.fromBytes;
...
fromBytesMap[mtx1Commands.getQuality.id] = mtx1Commands.getQuality.fromBytes;
...
fromBytesMap[mtx1Commands.setGsmParameters.id] = mtx1Commands.setGsmParameters.fromBytes;
