 ...
 */
export const REACTIVE_POWER_QPLUS_PHASE_A = 47;

/**
 * Reactive power of phase `B`, `Q+` (quadrant `QI + QII`) (`43.7.0`).
 */
export const REACTIVE_POWER_QPLUS_PHASE_B = 48;
 ...
 */
export const REACTIVE_POWER_QMINUS_PHASE_A = 51;

/**
 * Reactive power of phase `B`, `Q-` (quadrant `QIII + QIV`) (`44.7.0`).
 */
export const REACTIVE_POWER_QMINUS_PHASE_B = 52;
 ...
 */
export const APPARENT_POWER_QPLUS_PHASE_A = 59;

/**
 * Apparent power `S+` of phase `B` (quadrant `QI + QIV`) (`49.7.0`).
 */
export const APPARENT_POWER_QPLUS_PHASE_B = 60;
 ...
 */
export const HOUR_MINUTE_SECOND = 114;

/**
 * Current date of the meter clock (`0.9.2`).
 */
export const DATE_MONTH_YEAR = 115;

/**
 * Current transformer ratio (`0.4.2`).
 */
export const CURRENT_TRANSFORMATION_RATIO = 116;

/**
 * Voltage transformer ratio (`0.4.3`).
 */
export const VOLTAGE_TRANSFORMATION_RATIO = 117;

/**
 * Display current balance.
 */
export const CURRENT_BALANCE = 118;

/**
 * Display power threshold for tariff `T1` (`5.2.1`).
 *
 * since version `302.35.005`
 */
export const POWER_THRESHOLD_T1 = 119;

/**
 * Display power threshold for tariff `T2` (`5.2.2`).
 */
export const POWER_THRESHOLD_T2 = 120;

/**
 * Display power threshold for tariff `T3` (`5.2.3`).
 */
export const POWER_THRESHOLD_T3 = 121;

/**
 * Display power threshold for tariff `T4` (`5.2.4`).
 */
export const POWER_THRESHOLD_T4 = 122;

/**
 * Optical port speed (for additional display only).
 */
export const OPTOPORT_SPEED = 123;

/**
 * Magnetic induction (for additional display only).
 */
export const MAGNET_INDUCTION = 124;
