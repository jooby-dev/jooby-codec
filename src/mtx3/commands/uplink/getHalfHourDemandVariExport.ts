 ...
 *
 * The corresponding downlink command: `getHalfHourDemandVariExport`.
 *
 * @packageDocumentation
 *
 * @example create command instance from command body hex dump
 * ```js
 * import * as getHalfHourDemandVariExport from 'jooby-codec/mtx3/commands/uplink/getHalfHourDemandVariExport.js';
 *
 * // simple response
 * const bytes = [
 ...
 *
 * // decoded payload
 * const parameters = getHalfHourDemandVariExport.fromBytes(bytes);
 *
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx3/commands/GetHalfHourDemandVariExport.md#response)
 */
...
import {getHalfHourDemandVariExport as commandId} from '../../constants/uplinkIds.js';
