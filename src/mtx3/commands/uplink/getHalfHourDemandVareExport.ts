/**
 * Uplink command to get reactive energy `A-R-` (`II` quadrant) in half hours by date.
 *
 * The corresponding downlink command: `getHalfHourDemandVareExport`.
 *
 * @packageDocumentation
 *
 * @example create command instance from command body hex dump
 * ```js
 * import * as getHalfHourDemandVareExport from 'jooby-codec/mtx3/commands/uplink/getHalfHourDemandVareExport.js';
 *
 * // simple response
 * const bytes = [
 ...
 *
 * // decoded payload
 * const parameters = getHalfHourDemandVareExport.fromBytes(bytes);
 *
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx3/commands/GetHalfHourDemandVareExport.md#response)
 */
...
export const id: types.TCommandId = 0x55;
export const name: types.TCommandName = 'getHalfHourDemandVareExport';
