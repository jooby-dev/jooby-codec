...
import CommandBinaryBuffer, {ICommandBinaryBuffer, IGetMonthMaxDemandExportResponseParameters} from '../../utils/CommandBinaryBuffer.js';
 ...
 */
export const fromBytes = ( bytes: types.TBytes ): IGetMonthMaxDemandExportResponseParameters => {
 ...
 */
export const toBytes = ( parameters: IGetMonthMaxDemandExportResponseParameters ): types.TBytes => {
