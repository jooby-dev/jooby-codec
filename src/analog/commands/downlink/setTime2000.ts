...
import {TCommandId, TBytes, TUint8, TInt32} from '../../../types.js';
 ...
 */
export const fromBytes = ( data: TBytes ): ISetTime2000Parameters => {
 ...
 */
export const toBytes = ( parameters: ISetTime2000Parameters ): TBytes => {
