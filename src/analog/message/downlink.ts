...
toBytesMap[commands.getSignalQuality.id] = commands.getSignalQuality.toBytes;
...
fromBytesMap[commands.getSignalQuality.id] = commands.getSignalQuality.fromBytes;
