 ...
 * @example
 * ```js
 * import GetSerialPort from 'jooby-codec/obis-observer/commands/downlink/GetSerialPort.js';
 *
 * const parameters = {
 *     requestId: 7
 * };
 * const command = new GetSerialPort(parameters);
 *
 ...
 */
class GetSerialPort extends Command {
    ...
    static fromBytes ( [requestId]: Uint8Array ) {
        return new GetSerialPort({requestId});
    }
