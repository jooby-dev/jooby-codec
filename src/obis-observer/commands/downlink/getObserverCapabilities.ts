 ...
 * @example
 * ```js
 * import * as getObserverCapabilities from 'jooby-codec/obis-observer/commands/downlink/getObserverCapabilities.js';
 *
 * const parameters = {
 *     requestId: 7
 * };
 *
 * const bytes = getObserverCapabilities.toBytes(parameters);
 *
...
import {getObserverCapabilities as commandId} from '../../constants/downlinkIds.js';
