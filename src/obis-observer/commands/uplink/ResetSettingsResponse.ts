...
const COMMAND_ID = 0x93;
const COMMAND_SIZE = REQUEST_ID_SIZE + 1;

const examples: TCommandExampleList = [
    {
        name: 'reset settings response',
        parameters: {
            requestId: 7
        },
        hex: {header: '93 01', body: '07'}
    }
];
 ...
 */
class ResetSettingsResponse extends Command {
    ...
    static fromBytes ( [requestId]: Uint8Array ) {
        return new ResetSettingsResponse({requestId});
    }
...
export default ResetSettingsResponse;
