...
fromBytesMap[commands.getGsmParameters.id] = commands.getGsmParameters.toBytes;
...
fromBytesMap[commands.setGsmParameters.id] = commands.setGsmParameters.toBytes;
