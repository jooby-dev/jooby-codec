...
toBytesMap[commands.getCurrentDemand.id] = commands.getCurrentDemand.toBytes;
...
fromBytesMap[commands.getCurrentDemand.id] = commands.getCurrentDemand.fromBytes;
