...
export {default as gsmAccessTypeNames} from './gsmAccessTypeNames.js';
export {default as gsmBlockTypeNames} from './gsmBlockTypeNames.js';
...
export * as gsmAccessTypes from './gsmAccessTypes.js';
export * as gsmBlockTypes from './gsmBlockTypes.js';
