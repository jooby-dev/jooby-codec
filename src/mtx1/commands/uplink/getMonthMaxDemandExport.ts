 ...
 * ```js
 * import * as getMonthMaxDemandExport from 'jooby-codec/mtx1/commands/uplink/getMonthMaxDemandExport.js';
 *
 * // received max power
 * const bytes = [
 *     0x18, 0x03,
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx1/commands/GetMonthMaxDemandExport.md#response)
 */
