...
export * as getGsmParameters from './getGsmParameters.js';
...
export * as getCurrentDemand from './getCurrentDemand.js';
...
export * as setDemandParameters from './setDemandParameters.js';
export * as setDisplayParam from './setDisplayParam.js';
export * as setGsmParameters from './setGsmParameters.js';
