...
export const examples: command.TCommandExamples = {
    'block 0 request': {
        ...
        parameters: {
            index: 0,
            data: [
                174, 22, 0, 0, 0, 0, 2, 83, 84, 65, 84, 73, 67, 73, 80, 0, 0, 0, 0, 0, 0, 0, 0, 0,
    ...
    'block 1 request': {
        ...
        parameters: {
            index: 1,
            data: [0, 0, 204, 61, 180, 65, 0, 5, 0, 0, 0, 0, 210, 4]
        },
        bytes: [
            0x61, 0x41,
            0x01,
            0xda, 0x0e, 0x00, 0x00, 0xcc, 0x3d, 0xb4, 0x41, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0xd2, 0x04,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    'block 3 request': {
        ...
        parameters: {
            index: 3,
            data: [
                22, 5, 33, 10, 1, 7, 1, 0, 0, 0, 0, 0, 0, 0, 0, 77, 52, 159, 104, 16, 0, 0, 128, 0, 130, 0, 64, 7, 224, 0, 1, 1, 1, 10, 0, 0, 0, 0, 0
            ]
        },
        bytes: [
            0x61, 0x41,
            0x03,
            0xda, 0x27, 0x16, 0x05, 0x21, 0x0a, 0x01, 0x07, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
