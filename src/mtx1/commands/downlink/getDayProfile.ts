 ...
 * @example
 * ```js
 * import * as getDayProfile from 'jooby-codec/mtx1/commands/downlink/getDayProfile.js';
 *
 * const parameters = {
 *     tariffTable: 0,
 *     index: 5,
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx1/commands/GetDayProfile.md#request)
 */
