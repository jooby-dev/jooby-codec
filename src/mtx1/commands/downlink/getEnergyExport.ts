 ...
 * @example
 * ```js
 * import * as getEnergyExport from 'jooby-codec/mtx1/commands/downlink/getEnergyExport.js';
 ...
 * ```
 *
 * [Command format documentation](https://github.com/jooby-dev/jooby-docs/blob/main/docs/mtx1/commands/GetEnergyExport.md#request)
 */
